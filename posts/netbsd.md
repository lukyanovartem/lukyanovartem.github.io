...
tags: netbsd
---
Нужно использовать образ для архитектуры armv7, а не arm64, поскольку есть [баг с клавиатурой](https://gnats.netbsd.org/cgi-bin/query-pr-single.pl?number=55998), актуальный и для релиза 10.1
